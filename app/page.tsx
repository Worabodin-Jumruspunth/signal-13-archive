    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          <p className="eyebrow">PERSONAL DIGITIZATION PROJECT · BELLWETHER COUNTY</p>
      ...
      <section className="latest" id="tapes">
        ...
        <article className="post">
          <div className="post-body">
            ...
            <blockquote>“If you can hear this, the tower has already forgotten you.”</blockquote>
            <p>The cassette is marked <b>Tape 13</b>, but the recovered recording lasts only <b>00:42</b> and ends abruptly.</p>
            <p className="question">Who stopped the tape—and why did they leave the warning?</p>
            <p className="signature">— Mara</p>
          </div>
          ...
          <div className="player" aria-label="Tape 13 audio player">
            ...
            <div className="cassette">
              <div className="tape-label"><span>WBLW ARCHIVE</span><b>TAPE 13</b><small>UNKNOWN DATE · SIDE A</small></div>
            ...
            <button className="play" onClick={toggleTape} aria-label={playing ? "Pause Tape 13" : "Play Tape 13"}>
              <span>{playing ? "Ⅱ" : "▶"}</span>{playing ? "PAUSE RECORDING" : "PLAY RECORDING"}
            </button>
            ...
            {playing && <p className="audio-note">[ low static ] &nbsp; “...the tower has already forgotten you.”</p>}
            <p className="file-data">WBLW_T13_SIDEA.MP3 · 48 kHz · STEREO<br/>DURATION: 00:42 · CHECKSUM: <span>VERIFIED</span></p>
          </div>
        </article>
      </section>
      ...
      <section className="transcript" id="transcript">
        ...
        <div className="paper">
          ...
          <p className="redacted"><time>00:27</time> ███████ RADIO GLITCH ███████</p>
          <p className="glitch"><time>00:30</time> SECOND VOICE ENTERS / SOURCE UNKNOWN</p>
          <p><time>00:42</time> [recording cuts off]</p>
          <div className="margin-note">The beginnings survived, but the signal drifted one letter forward. Reverse the drift. — M</div>
        </div>
        ...
        {unlocked && <aside className="unlocked-log" aria-live="polite">
          ...
          <p><time>01:12</time> System began repeating the name “Eli Venn.”</p>
          <p><time>01:13</time> Manual shutdown failed.</p>
          <p className="burned">[ THE REMAINDER OF THIS PAGE IS DAMAGED BY FIRE ]</p>
          <blockquote>“The first recovery key is the cipher key. Repeat it above the carrier. Count A as zero, then subtract the key. If the tower speaks again, the shutdown failed.”</blockquote>
      ...
      <section className="index">
        ...
        <div className="records">
          {schedule.map(([name,date,status],i)=><div className={status === "SEALED" && !(i === 1 && unlocked) ? "record sealed" : "record"} key={name}>
            <span className="record-no">{String(i+1).padStart(2,"0")}</span><div><h3>{name}</h3><p>{date}</p></div><b>{i === 1 && unlocked ? "UNLOCKED" : status}</b>
          </div>)}
        </div>
      ...
      <footer>
        <span>WBLW ARCHIVE · INDEPENDENT RECOVERY PROJECT</span>
        <button onClick={() => setAboutOpen(true)}>This is a fictional interactive story · Safety &amp; content notes</button>
      </footer>
